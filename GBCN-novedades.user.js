...
gigantes.forEach(cuadro => cuadro.parentElement.parentElement.parentElement.style.backgroundColor = "darkgoldenrod");

let agencias = document.querySelectorAll("a[href='tag-escorts-de-agencia.html']");
agencias.forEach((cuadro) => {
  cuadro.parentElement.parentElement.parentElement.style.visibility = "hidden";
  cuadro.parentElement.parentElement.parentElement.getElementsByTagName("h4")[0].style.visibility = "visible";
});